...
const Login = () => {
  ...
  const handleNextStep = () => {
    ...
    setError('');
    setStep(2); // Avanzar al segundo paso si no hay error
  };
      ...
      <div className="flex w-full max-w-4xl bg-white rounded-lg shadow-lg">
        ...
        <div className="w-full md:w-1/2 p-8">
          {step === 1 ? (
            ...
            <div>
              <h2 className="text-2xl font-bold mb-6 text-center">Ingrese su contraseña</h2>
              <p className="mb-4 text-gray-700">Correo: {email}</p>
              <div className="mb-4">
